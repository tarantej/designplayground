            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="user_login" class="col-md-4 col-form-label text-md-right">{{ __('Login Name') }}</label>

                            <div class="col-md-6">
                                <input id="user_login" type="text" class="form-control @error('user_login') is-invalid @enderror" name="user_login" value="{{ old('user_login') }}" required autocomplete="user_login" autofocus>
